...
class CodeSnippetExporter {
  ...
  static String _generateJava({
    ...
    return '''// $systemLabel — Generated by REV System Identification
// REVLib 2025 (Java)
...
$velSlot$posSlot
  ...
  static String _generatePython({
    ...
    final velSection = velocityPid != null ? '''
        ...
        config.closedLoop.pidf($velP, $velI, $velD, 0.0)
$ffLines''' : '';

    final posSection = positionPid != null ? '''

        # --- Position PID (Slot 1) ---
        config.closedLoop.slot1.pidf($posP, $posI, $posD, 0.0)
$ffLinesSlot1''' : '';
...
$velSection$posSection
  ...
  static String _generateCpp({
    ...
    // --- Velocity PID (Slot 0) ---
    config.closedLoop
        .FeedbackSensor(rev::spark::ClosedLoopConfig::FeedbackSensor::kPrimaryEncoder)
        .Pidf($velP, $velI, $velD, 0.0);
$ffLines''' : '';
